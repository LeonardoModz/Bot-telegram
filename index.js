...
const token = '7020419354:AAGlEJJxjOc8mTzN4zhu_poKBRDJqVqWlgg';
...
function logActivity(msg) {
  ...
  console.log(`• User ID: ${1931669916}`);
  console.log(`• Username: ${@LeoModzCasinobot|| 'Tidak ada'}`);
  console.log(`• Chat ID: ${1931669916}`);
  console.log(`• Perintah: ${/menu}`);
}
